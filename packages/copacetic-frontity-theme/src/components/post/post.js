...
import { PatternBox } from "../newsletter";
...
const Post = ({ state, actions, libraries }) => {
  ...
  return (
      <LightPatternBox showPattern={state.theme.showBackgroundPattern} backgroundPattern={state.theme.backgroundPattern} ref={ref}>
